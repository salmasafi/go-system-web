...
import 'package:systego/features/admin/points/presentation/view/points_screen.dart';
...
import 'package:systego/features/admin/redeem_points/presentation/view/redeem_points_screen.dart';
...
import 'package:systego/features/admin/units/presentation/view/units_screen.dart';
...
import 'package:systego/features/admin/purchase_returns/presentation/view/purchase_returns_screen.dart';
import 'package:systego/features/admin/expense_admin/presentation/view/expense_admin_screen.dart';
...
enum DashboardItem {
  // Product Management
  products, categories, brands, attributes, units, printLabels,
  // Financial
  financialAccounts, taxes, discounts, expenses, expenseCategories,
  revenue, payment, payments,
  // Marketing
  popups, points, redeemPoints, bundles, coupons,
  // Settings
  barcode, cities, countries, zones, permissions, currencies, decimalSettings, serviceFees, couriers,
  // Inventory
  warehouses, transfers, purchase, returns, adjustments, reasons,
  // CRM
  suppliers, customers, customerGroups,
  // HRM
  admins, cashiers, roles, departments,
  // Reports
  salesReport, inventoryReport, financialReport, customerReport,
  productReport, expensesReport, revenueReport,
}
...
class _DashboardScreenState extends State<DashboardScreen> {
  ...
  List<_DashboardGroup> _buildGroups() {
    return [
      _DashboardGroup(
        ...
        modules: [
          _ModuleItem(icon: Icons.inventory_2_rounded, label: LocaleKeys.products.tr(), id: DashboardItem.products),
          _ModuleItem(icon: Icons.grid_view_rounded, label: LocaleKeys.categories_title.tr(), id: DashboardItem.categories),
          _ModuleItem(icon: Icons.local_offer_rounded, label: LocaleKeys.brands_title.tr(), id: DashboardItem.brands),
          _ModuleItem(icon: Icons.tune_rounded, label: LocaleKeys.attributes_title.tr(), id: DashboardItem.attributes),
          _ModuleItem(icon: Icons.straighten_rounded, label: LocaleKeys.units_title.tr(), id: DashboardItem.units),
          _ModuleItem(icon: Icons.qr_code_rounded, label: LocaleKeys.print_labels_title.tr(), id: DashboardItem.printLabels),
        ],
      ),
      _DashboardGroup(
        ...
        modules: [
          _ModuleItem(icon: Icons.account_balance_rounded, label: LocaleKeys.financial_accounts.tr(), id: DashboardItem.financialAccounts),
          _ModuleItem(icon: Icons.receipt_long_rounded, label: LocaleKeys.taxes.tr(), id: DashboardItem.taxes),
          _ModuleItem(icon: Icons.discount_rounded, label: LocaleKeys.discounts_title.tr(), id: DashboardItem.discounts),
          _ModuleItem(icon: Icons.money_off_rounded, label: LocaleKeys.expenses_title.tr(), id: DashboardItem.expenses),
          _ModuleItem(icon: Icons.category_rounded, label: LocaleKeys.expense_categories_title.tr(), id: DashboardItem.expenseCategories),
          _ModuleItem(icon: Icons.trending_up_rounded, label: LocaleKeys.revenues_title.tr(), id: DashboardItem.revenue),
          _ModuleItem(icon: Icons.payment_rounded, label: LocaleKeys.payment_methods_screen_title.tr(), id: DashboardItem.payment),
          _ModuleItem(icon: Icons.payments_rounded, label: LocaleKeys.payments_title.tr(), id: DashboardItem.payments, comingSoon: true),
        ],
      ),
      _DashboardGroup(
        ...
        modules: [
          _ModuleItem(icon: Icons.open_in_new_rounded, label: LocaleKeys.popups_title.tr(), id: DashboardItem.popups),
          _ModuleItem(icon: Icons.stars_rounded, label: LocaleKeys.points_title.tr(), id: DashboardItem.points),
          _ModuleItem(icon: Icons.redeem_rounded, label: LocaleKeys.redeem_points_title.tr(), id: DashboardItem.redeemPoints),
          _ModuleItem(icon: Icons.inventory_rounded, label: LocaleKeys.bundles_title.tr(), id: DashboardItem.bundles),
          _ModuleItem(icon: Icons.local_offer_rounded, label: LocaleKeys.coupons_title.tr(), id: DashboardItem.coupons),
        ],
      ),
      _DashboardGroup(
        ...
        modules: [
          _ModuleItem(icon: Icons.qr_code_scanner_rounded, label: LocaleKeys.barcode_title.tr(), id: DashboardItem.barcode, comingSoon: true),
          _ModuleItem(icon: Icons.location_city_rounded, label: LocaleKeys.cities_title.tr(), id: DashboardItem.cities),
          _ModuleItem(icon: Icons.flag_rounded, label: LocaleKeys.countries_title.tr(), id: DashboardItem.countries),
          _ModuleItem(icon: Icons.gps_fixed_rounded, label: LocaleKeys.zones_screen_title.tr(), id: DashboardItem.zones),
          _ModuleItem(icon: Icons.lock_rounded, label: LocaleKeys.permissions.tr(), id: DashboardItem.permissions),
          _ModuleItem(icon: Icons.monetization_on_rounded, label: LocaleKeys.currencies_title.tr(), id: DashboardItem.currencies),
        ],
      ),
      _DashboardGroup(
        ...
        modules: [
          _ModuleItem(icon: Icons.warehouse_rounded, label: LocaleKeys.warehouses.tr(), id: DashboardItem.warehouses),
          _ModuleItem(icon: Icons.swap_horiz_rounded, label: LocaleKeys.transfers_title.tr(), id: DashboardItem.transfers),
          _ModuleItem(icon: Icons.shopping_cart_rounded, label: LocaleKeys.purchase_title.tr(), id: DashboardItem.purchase),
          _ModuleItem(icon: Icons.assignment_return_rounded, label: LocaleKeys.returns_title.tr(), id: DashboardItem.returns),
          _ModuleItem(icon: Icons.build_rounded, label: LocaleKeys.adjustments.tr(), id: DashboardItem.adjustments),
          _ModuleItem(icon: Icons.rule_rounded, label: LocaleKeys.reasons.tr(), id: DashboardItem.reasons),
        ],
      ),
      _DashboardGroup(
        ...
        modules: [
          _ModuleItem(icon: Icons.factory_rounded, label: LocaleKeys.suppliers_title.tr(), id: DashboardItem.suppliers),
          _ModuleItem(icon: Icons.person_rounded, label: LocaleKeys.customers_title.tr(), id: DashboardItem.customers),
          _ModuleItem(icon: Icons.group_rounded, label: LocaleKeys.customer_groups_title.tr(), id: DashboardItem.customerGroups),
        ],
      ),
      _DashboardGroup(
        ...
        accentColor: const Color(0xFF546E7A),
        modules: [
          _ModuleItem(icon: Icons.admin_panel_settings_rounded, label: LocaleKeys.admins.tr(), id: DashboardItem.admins),
          _ModuleItem(icon: Icons.point_of_sale_rounded, label: LocaleKeys.cashiers_title.tr(), id: DashboardItem.cashiers),
          _ModuleItem(icon: Icons.security_rounded, label: LocaleKeys.roles_title.tr(), id: DashboardItem.roles),
        ],
      ),
      _DashboardGroup(
        ...
        modules: [
          _ModuleItem(icon: Icons.point_of_sale_rounded, label: LocaleKeys.cashier_shifts.tr(), id: DashboardItem.cashiers, comingSoon: true),
          _ModuleItem(icon: Icons.shopping_cart_rounded, label: LocaleKeys.orders_report.tr(), id: DashboardItem.salesReport, comingSoon: true),
          _ModuleItem(icon: Icons.assessment_rounded, label: LocaleKeys.product_report.tr(), id: DashboardItem.productReport, comingSoon: true),
          _ModuleItem(icon: Icons.account_balance_rounded, label: LocaleKeys.financial_report.tr(), id: DashboardItem.financialReport, comingSoon: true),
          _ModuleItem(icon: Icons.inventory_rounded, label: LocaleKeys.product_movement_report.tr(), id: DashboardItem.inventoryReport, comingSoon: true),
        ],
      ),
    ];
  }
  ...
  void _navigateToPage(DashboardItem id) {
    ...
    switch (id) {
      case DashboardItem.products:
        screen = MultiBlocProvider(
          providers: [
            ...
            BlocProvider(create: (_) => ProductFiltersCubit()),
          ],
      ...
      case DashboardItem.transfers:
        screen = MultiBlocProvider(
          providers: [
            BlocProvider(create: (_) => TransfersCubit()),
            BlocProvider(create: (_) => WareHouseCubit()),
          ],
      ...
      case DashboardItem.returns:
        screen = MultiBlocProvider(
          providers: [
            BlocProvider(create: (_) => PurchaseReturnCubit()),
            BlocProvider(create: (_) => BankAccountCubit()),
          ],
      ...
      case DashboardItem.redeemPoints:
        screen = MultiBlocProvider(
          providers: [
            BlocProvider(create: (_) => RedeemPointsCubit()),
          ],
        ...
        content: Column(
          ...
          children: [
            Container(
              ...
              child: Icon(Icons.rocket_launch_rounded, size: ResponsiveUI.iconSize(context, 48), color: AppColors.primaryBlue),
            ),
            SizedBox(height: ResponsiveUI.value(context, 20)),
            Text(
              LocaleKeys.coming_soon_title.tr(),
              style: TextStyle(fontSize: ResponsiveUI.fontSize(context, 20), fontWeight: FontWeight.bold, color: AppColors.darkGray),
            ),
            SizedBox(height: ResponsiveUI.value(context, 10)),
            Text(
              LocaleKeys.coming_soon_message.tr(),
              textAlign: TextAlign.center,
              style: TextStyle(fontSize: ResponsiveUI.fontSize(context, 14), color: AppColors.darkGray.withValues(alpha: 0.7), height: ResponsiveUI.value(context, 1.5)),
            ),
          ],
        ),
        actions: [
          SizedBox(
            ...
            child: ElevatedButton(
              ...
              child: Text(LocaleKeys.ok.tr(), style: TextStyle(fontSize: ResponsiveUI.fontSize(context, 16), fontWeight: FontWeight.w600)),
            ),
          ),
        ],
      ),
  ...
  Widget build(BuildContext context) {
    ...
    return BlocBuilder<NotificationsCubit, NotificationsState>(
      builder: (context, state) {
        final unreadCount = state is NotificationsSuccess ? state.unreadCount : 0;
        return Scaffold(
  ...
  Widget _buildGroupCard(_DashboardGroup group, int groupIndex) {
    ...
    final borderRadius = BorderRadius.circular(ResponsiveUI.borderRadius(context, 16));
    ...
    return Padding(
      ...
      child: AnimatedContainer(
        ...
        decoration: BoxDecoration(
          ...
          boxShadow: [
            BoxShadow(
              color: group.accentColor.withValues(alpha: isExpanded ? 0.12 : 0.06),
                  ...
                  child: Row(
                    children: [
                      Container(
                        ...
                        child: Icon(group.icon, color: group.accentColor, size: ResponsiveUI.iconSize(context, 22)),
                      ),
  ...
  Widget _buildModulesGrid(_DashboardGroup group) {
    return Container(
      ...
      child: Column(
        children: [
          Divider(color: AppColors.lightGray.withValues(alpha: 0.5), height: ResponsiveUI.value(context, 1)),
            ...
            children: [
                ...
                child: Column(
                  ...
                  children: [
                    Container(
                      ...
                      decoration: BoxDecoration(
                        color: module.comingSoon ? accentColor.withValues(alpha: 0.05) : accentColor.withValues(alpha: 0.12),
                        shape: BoxShape.circle,
                      ),
                      child: Icon(
                        module.icon,
                        size: ResponsiveUI.iconSize(context, 32),
                        color: module.comingSoon ? accentColor.withValues(alpha: 0.4) : accentColor,
                      ),
                    ),
                    SizedBox(height: ResponsiveUI.spacing(context, 12)),
                    Padding(
                      ...
                      child: Text(
                        ...
                        style: TextStyle(
                          ...
                          color: module.comingSoon
                              ? (isDarkMode ? Colors.white54 : AppColors.darkGray.withValues(alpha: 0.5))
              ...
              if (module.comingSoon)
                Positioned(
                  ...
                  child: Container(
                    padding: EdgeInsets.symmetric(horizontal: ResponsiveUI.padding(context, 6), vertical: ResponsiveUI.padding(context, 2)),
                    decoration: BoxDecoration(
                    ...
                    child: Text(
                      ...
                      style: TextStyle(fontSize: ResponsiveUI.fontSize(context, 8), fontWeight: FontWeight.bold, color: Colors.white),
                    ),
                  ),
                ),
            ],
