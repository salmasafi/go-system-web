...
class AdminModel {
  ...
  final String email;
  final String role;
  final RoleData? roleData; // Corresponds to "role_id" object
  final String status;
  final String companyName;
  final String phone;
  ...
  factory AdminModel.fromJson(Map<String, dynamic> json) {
    return AdminModel(
      ...
      // Parse nested role_id object
      roleData: json['role_id'] != null
          ? RoleData.fromJson(json['role_id'] as Map<String, dynamic>)
          : null,
      status: json['status'] as String? ?? '',
      companyName: json['company_name'] as String? ?? '',
      phone: json['phone'] as String? ?? '',
      // Parse nested warehouse object
...
// New helper class for the "warehouse" object
...
// New helper class for the "role_id" object
class RoleData {
  final String id;
  final String name;
