...
//             fontWeight: FontWeight.w500,
//             color:
//                 isActive ? AppColors.successGreen : AppColors.darkGray.withValues(alpha: 0.6),
//           ),
//         ),
//       ],
//     );
...
class _AnimatedAdminCardState extends State<AnimatedAdminCard> {
    ...
    return Row(
      ...
      children: [
        CircleAvatar(
          ...
          backgroundColor: AppColors.darkBlue,
          child: Text(
            admin.username.isNotEmpty ? admin.username[0].toUpperCase() : '?',
            style: TextStyle(
              color: Colors.white,
              fontSize: ResponsiveUI.fontSize(context, 20),
              fontWeight: FontWeight.bold,
  ...
  Widget _buildFooter(AdminModel admin) {
    ...
    // Access nested Role name, fallback to simple role string if null
    final roleName = admin.roleData?.name ?? admin.role;
    
    // Access nested Warehouse name
    final warehouseName = admin.warehouse?.name ?? '-';
      ...
      children: [
        ...
        Row(
          children: [
            ...
            // Adjust spacing or use Spacer() if strictly 80 is not required
            SizedBox(width: ResponsiveUI.spacing(context, 40)), 
