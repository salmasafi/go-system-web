...
class _CountryFormDialogState extends State<CountryFormDialog>
  ...
  bool get isEditMode => widget.country != null;
      ...
      child: Dialog(
        ...
        child: BlocConsumer<CountryCubit, CountryState>(
          ...
          builder: (context, state) {
            final isLoading =
                state is CreateCountryLoading || state is UpdateCountryLoading;
...
class CountryDialogButtons extends StatelessWidget {
  final bool isEditMode;
  final bool isLoading;
  final VoidCallback onCancel;
  final VoidCallback onSubmit;

  const CountryDialogButtons({
    super.key,
    required this.isEditMode,
