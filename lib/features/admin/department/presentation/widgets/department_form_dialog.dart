...
class _DepartmentFormDialogState extends State<DepartmentFormDialog>
      ...
      child: Dialog(
        ...
        child: BlocConsumer<DepartmentCubit, DepartmentState>(
          ...
          builder: (context, state) {
            final isLoading =
                state is CreateDepartmentLoading || state is UpdateDepartmentLoading;
  ...
  void _handleStateChanges(BuildContext context, DepartmentState state) {
    if (state is CreateDepartmentSuccess || state is UpdateDepartmentSuccess) {
      Navigator.of(context).pop();
    }

    if (state is CreateDepartmentError) {
...
class DepartmentDialogHeader extends StatelessWidget {
  final bool isEditMode;
  final VoidCallback onClose;

  const DepartmentDialogHeader({
    super.key,
...
class DepartmentDialogButtons extends StatelessWidget {
  final bool isEditMode;
