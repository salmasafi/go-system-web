...
import 'package:GoSystem/features/admin/expences_category/presentation/widgets/expences_categories_form_dialog.dart';
import 'package:GoSystem/features/admin/expences_category/presentation/widgets/expences_categories_list.dart';
    ...
    Widget screenContent = Scaffold(
      ...
      appBar: appBarWithActions(
        ...
        onPressed: () {
          showDialog(
            context: context,
            builder: (context) => const ExpenseCategoryFormDialog(),
          );
        },
      ),
      body: SafeArea(
